    ...
    <form class="layui-form layui-form-pane" action="" lay-filter="addAndEditCustomerFrame" id="addAndEditCustomerFrame"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="text" name="custName" lay-verify="username" autocomplete="off" class="layui-input"
                       placeholder="请输入客户姓名">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="custPhone" id="custPhone" lay-verify="required|number|phone|userPhone" autocomplete="off"
    ...
    layui.use(['table', 'layer', 'form', 'jquery', 'laydate'], function () {
        ...
        form.verify({
            userPhone: function(value){
                ...
                var message = '';
                $.ajax({
                    url: "${Path}/customer/checkCustomerPhones",
                    type: 'POST',
                    data: formData,
                    async: false,
                    cache: false,
