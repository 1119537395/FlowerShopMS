...
public class CustomerController {
	 ...
	 * @param customerVo
	 * @return CommonReturnType
	 * @description 校验客户手机号是否存在
	 * @author 柚子茶
	 * @date 2021/3/7 13:16
	 **/
	@RequestMapping("checkCustomerPhones")
	 ...
	 * @description 获取客户姓名
	 * @author 柚子茶
	 * @date 2021/4/15 21:19
	 **/
	@RequestMapping("getCustomerNameByPhone")
	public Customer getCustomerNameByPhone(CustomerVo customerVo) {
		return this.customerService.getCustomerNameByPhone(customerVo.getCustPhone());
	}
